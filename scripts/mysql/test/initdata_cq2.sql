...
begin
 ...
 declare num_max_u bigint default 100;
 declare num_max_i bigint default 1000;
 
 declare num_u int default 0;
 declare num_i int default 0;

 declare num_u_i int default 100;
 declare num_mod int default 100;

 declare num_floor int default 100;
 ...
 set num_floor=num_max_i/num_mod;
 ...
 while(num_i<=num_max_i) do
   ...
   */
   if mod(num_i,num_floor) < num_mod THEN
     select mod(num_i,num_floor);
   end if;
